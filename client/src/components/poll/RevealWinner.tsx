  ...
  return (
    <>
      <div className="relative overflow-hidden rounded-[length:var(--radius-lg)] border-[length:var(--border-card)] border-cocoa bg-tangerine p-8 text-center">
        ...
        <span className="inline-flex rounded-full bg-[var(--color-scrim-on-tangerine)] px-3 py-1 font-body text-sm font-bold uppercase tracking-[0.06em] text-cream-bright">
        ...
        <span className="mt-2 inline-flex rounded-full bg-[var(--color-scrim-on-tangerine)] px-3.5 py-1.5 font-body text-sm font-bold tabular-nums text-cream-bright">
          {winnerTally.votes} of {presentation.totalVotes} vote{presentation.totalVotes === 1 ? "" : "s"}
        </span>
        <p className="mt-4 flex items-center justify-center gap-1.5 rounded-full bg-[var(--color-scrim-on-tangerine)] px-3.5 py-1.5 font-body text-sm text-cream-bright">
